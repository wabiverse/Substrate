...
//
  ...
  class VulkanRenderPass {
    ...
    init(device: VulkanDevice, descriptor: VulkanRenderTargetDescriptor, resourceMap: VulkanPersistentResourceRegistry) async throws {
      self.device = device
      ...
      do {
        var previousSubpass: VulkanSubpass?
