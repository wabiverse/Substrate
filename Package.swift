...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/troughton/SPIRV-Cross-SPM", from: "0.44.0"),
        ...
        .package(url: "https://github.com/troughton/Wuffs-SPM", from: "0.3.02"),
    ...
    targets: [
        ...
        .target(name: "SubstrateImageIO", dependencies: ["SubstrateImage",
                                                         ...
                                                         .product(name: "LodePNG", package: "LodePNG-SPM"),
                                                         .product(name: "WuffsAux", package: "Wuffs-SPM"),
                                                         .product(name: "CWuffs", package: "Wuffs-SPM")],
                swiftSettings: [
                ]),
        ...
        .target(name: "Substrate", dependencies: ["SubstrateUtilities", "SubstrateCExtras", .product(name: "Atomics", package: "swift-atomics"), .product(name: "SPIRV-Cross", package: "SPIRV-Cross-SPM"), .product(name: "OrderedCollections", package: "swift-collections")] + vulkanDependencies, path: "Sources/Substrate", exclude: ["CMakeLists.txt", "MetalBackend/CMakeLists.txt", "VulkanBackend/CMakeLists.txt"],
                swiftSettings: [
...
//                    .unsafeFlags(["-enforce-exclusivity=unchecked"])
        ...
        .target(name: "SPIRVCrossExtras",
                dependencies: [.product(name: "SPIRV-Cross", package: "SPIRV-Cross-SPM")]),
        
        .target(
            name: "ShaderTool",
            dependencies: [.product(name: "SPIRV-Cross", package: "SPIRV-Cross-SPM"), "SPIRVCrossExtras", "Substrate", "Regex", .product(name: "ArgumentParser", package: "swift-argument-parser")]),
